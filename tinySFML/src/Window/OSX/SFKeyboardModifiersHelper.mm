...
void processOneModifier(NSUInteger modifiers, NSUInteger mask,
                        BOOL& wasDown, tinySFML::Keyboard::Key key,
                        tinySFML::priv::WindowImplCocoa& requester);
...
void processLeftRightModifiers(NSUInteger modifiers,
                               ...
                               tinySFML::Keyboard::Key leftKey, tinySFML::Keyboard::Key rightKey,
                               tinySFML::priv::WindowImplCocoa& requester);
...
void handleModifiersChanged(NSUInteger modifiers, tinySFML::priv::WindowImplCocoa& requester)
{
    ...
    processLeftRightModifiers(
        ...
        tinySFML::Keyboard::LShift, tinySFML::Keyboard::RShift,
        requester
    );
    ...
    processLeftRightModifiers(
        ...
        tinySFML::Keyboard::LSystem, tinySFML::Keyboard::RSystem,
        requester
    );
    ...
    processLeftRightModifiers(
        ...
        tinySFML::Keyboard::LAlt, tinySFML::Keyboard::RAlt,
        requester
    );
    ...
    processLeftRightModifiers(
        ...
        tinySFML::Keyboard::LControl, tinySFML::Keyboard::RControl,
        requester
    );
}
                        ...
                        tinySFML::priv::WindowImplCocoa& requester)
{
    ...
    tinySFML::Event::KeyEvent event = keyEventWithModifiers(modifiers, key);
