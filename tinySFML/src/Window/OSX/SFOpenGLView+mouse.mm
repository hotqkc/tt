...
#import <Window/OSX/SFOpenGLView+mouse_priv.h>
...
{
    tinySFML::Mouse::Button button = [SFOpenGLView mouseButtonFromEvent:theEvent];

    if (m_requester != 0)
    {
        NSPoint loc = [self cursorPositionFromEvent:theEvent];

        if (button != tinySFML::Mouse::ButtonCount)
...
////////////////////////////////////////////////////////
+(tinySFML::Mouse::Button)mouseButtonFromEvent:(NSEvent*)event
{
    switch ([event buttonNumber])
    {
        case 0:     return tinySFML::Mouse::Left;
        case 1:     return tinySFML::Mouse::Right;
        case 2:     return tinySFML::Mouse::Middle;
        case 3:     return tinySFML::Mouse::XButton1;
        case 4:     return tinySFML::Mouse::XButton2;
        default:    return tinySFML::Mouse::ButtonCount; // Never happens! (hopefully)
    }
}
