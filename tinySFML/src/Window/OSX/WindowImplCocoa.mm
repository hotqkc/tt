...
#import <Window/OSX/AutoreleasePoolWrapper.h>
#import <Window/OSX/cpp_objc_conversion.h>
#import <Window/OSX/Scaling.h>
#import <Window/OSX/SFApplication.h>
#import <Window/OSX/SFApplicationDelegate.h>
#import <Window/OSX/SFKeyboardModifiersHelper.h>
...
m_showCursor(true)
{
    ...
    else
    {
        ...
        tinySFML::err() << "Cannot import this Window Handle because it is neither "
...
WindowImplCocoa::~WindowImplCocoa()
{
    ...
    // This solve some issue when tinySFML::Window::Create is called for the
...
Vector2i WindowImplCocoa::getPosition() const
{
    ...
    tinySFML::Vector2i ret(pos.x, pos.y);
...
{
    tinySFML::Vector2i backingPosition = position;
...
{
    tinySFML::Vector2u backingSize = size;
