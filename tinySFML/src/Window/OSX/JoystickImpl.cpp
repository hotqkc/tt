...
#include <Window/OSX/HIDJoystickManager.hpp>
...
namespace
{
    ...
    std::string getDeviceString(IOHIDDeviceRef ref, CFStringRef prop, unsigned int index)
    {
        ...
        tinySFML::err() << "Unable to read string value for property '" << stringFromCFString(prop) << "' for joystick at index " << index << std::endl;
    ...
    unsigned int getDeviceUint(IOHIDDeviceRef ref, CFStringRef prop, unsigned int index)
    {
        ...
        tinySFML::err() << "Unable to read uint value for property '" << stringFromCFString(prop) << "' for joystick at index " << index << std::endl;
        return 0;
    }
}
...
{
////////////////////////////////////////////////////////////
JoystickImpl::Location JoystickImpl::m_locationIDs[tinySFML::Joystick::Count] = { 0 };
...
bool JoystickImpl::isConnected(unsigned int index)
{
    ...
    else
    {
        ...
        for (unsigned int i(0); i < tinySFML::Joystick::Count; ++i)
        {
            ...
            case kHIDPage_GenericDesktop:
                switch (IOHIDElementGetUsage(element))
                {
                    ...
                    case kHIDUsage_GD_GamePad:
                        ...
                        {
                            tinySFML::err() << std::hex << "Gamepage (vendor/product id: 0x" << m_identification.vendorId
                    ...
                    default:
#ifdef SFML_DEBUG
                        tinySFML::err() << "Unexpected usage for element of Page Generic Desktop: 0x" << std::hex << IOHIDElementGetUsage(element) << std::dec << std::endl;
#endif
                        break;
                }
                break;
